...
import j.jave.framework.components.memcached.JMemcached;
...
public class UnitTest extends TestCase {
	...
	public void testSaveUser(){
		...
		try{
			...
			JMemcached jMemcached=  (JMemcached) applicationContext.getBean("simpleReplicateMemcached");
			
			jMemcached.set("i", 0, "i am from ");
			
			System.out.println(jMemcached.get("i"));
