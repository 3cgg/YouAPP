 ...
 */
public abstract class JResourceHolderSupport implements JResourceHolder {
	 ...
	 * @throws JTransactionTimedOutException if the deadline has already been reached
	 */
	 ...
	 * @throws JTransactionTimedOutException if the deadline has already been reached
	 */
	public long getTimeToLiveInMillis() throws JTransactionTimedOutException{
	 ...
	 * and throw a JTransactionTimedOutException.
	 */
	private void checkTransactionTimeout(boolean deadlineReached) throws JTransactionTimedOutException {
		if (deadlineReached) {
			setRollbackOnly();
			throw new JTransactionTimedOutException("Transaction timed out: deadline was " + this.deadline);
		}
	}
