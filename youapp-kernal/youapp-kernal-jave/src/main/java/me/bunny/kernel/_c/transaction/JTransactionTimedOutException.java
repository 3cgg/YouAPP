...
public class JTransactionTimedOutException extends JTransactionException {

	/**
	 * Constructor for TransactionTimedOutException.
	 * @param msg the detail message
	 */
	public JTransactionTimedOutException(String msg) {
		super(msg);
	}
	 ...
	 */
	public JTransactionTimedOutException(String msg, Throwable cause) {
		super(msg, cause);
	}
