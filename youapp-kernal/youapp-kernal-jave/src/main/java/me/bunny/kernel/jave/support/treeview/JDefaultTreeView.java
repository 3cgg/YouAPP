...
import me.bunny.kernel.jave.support.JView;
 ...
 *
 */
public class JDefaultTreeView implements
		JView {

	private final JTree tree;
	
	public JDefaultTreeView(JTree tree){
		this.tree=tree;
	}
	...
	public List<JNodeTreeView> models(){
		...
		for (Iterator<JTreeNode> iterator = tree.getTreeNodes().iterator(); iterator.hasNext();) {
			...
			while(treeWalker.hasNext()){
				...
				JSimpleTreeStrcture treeStrcture= walkerTreeNode.getData();
