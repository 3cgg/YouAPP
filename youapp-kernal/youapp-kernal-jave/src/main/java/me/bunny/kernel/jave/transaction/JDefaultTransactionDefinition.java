...
public class JDefaultTransactionDefinition implements JTransactionDefinition, Serializable {
	...
	static final JConstantsUtil constants = new JConstantsUtil(JTransactionDefinition.class);
	 ...
	 * @see #setName
	 */
	public JDefaultTransactionDefinition() {
	}
	 ...
	 * @see #setName
	 */
	public JDefaultTransactionDefinition(JTransactionDefinition other) {
	 ...
	 * @see #setReadOnly
	 */
	public JDefaultTransactionDefinition(int propagationBehavior) {
	...
	public boolean equals(Object other) {
		return (other instanceof JTransactionDefinition && toString().equals(other.toString()));
	}
