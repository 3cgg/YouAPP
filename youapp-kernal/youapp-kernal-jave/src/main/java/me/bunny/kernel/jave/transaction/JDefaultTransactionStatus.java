...
public class JDefaultTransactionStatus extends JAbstractTransactionStatus {
	 ...
	 */
	public JDefaultTransactionStatus(
	...
	public boolean isGlobalRollbackOnly() {
		return ((this.transaction instanceof JSmartTransactionObject) &&
				((JSmartTransactionObject) this.transaction).isRollbackOnly());
	}
	...
	@Override
	public void flush() {
		if (this.transaction instanceof JSmartTransactionObject) {
			((JSmartTransactionObject) this.transaction).flush();
		}
	}
