 ...
 */
public interface JSavepointManager {
	 ...
	 */
	Object createSavepoint() throws JTransactionException;
	 ...
	 */
	void rollbackToSavepoint(Object savepoint) throws JTransactionException;
	 ...
	 */
	void releaseSavepoint(Object savepoint) throws JTransactionException;
