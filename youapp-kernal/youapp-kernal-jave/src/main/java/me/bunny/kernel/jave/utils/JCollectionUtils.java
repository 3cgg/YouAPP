...
public abstract class JCollectionUtils {
	 ...
	 * @see JObjectUtils#toObjectArray(Object)
	 * @see Arrays#asList(Object[])
	 */
	@SuppressWarnings("rawtypes")
	public static List arrayToList(Object source) {
		return Arrays.asList(JObjectUtils.toObjectArray(source));
	}
	...
	public static <E> void mergeArrayIntoCollection(Object array, Collection<E> collection) {
		...
		Object[] arr = JObjectUtils.toObjectArray(array);
		for (Object elem : arr) {
	...
	public static boolean contains(Iterator<?> iterator, Object element) {
		if (iterator != null) {
			while (iterator.hasNext()) {
				...
				if (JObjectUtils.nullSafeEquals(candidate, element)) {
					return true;
				}
			}
		}
	...
	public static Object findValueOfType(Collection<?> collection, Class<?>[] types) {
		if (isEmpty(collection) || JObjectUtils.isEmpty(types)) {
			return null;
		}
