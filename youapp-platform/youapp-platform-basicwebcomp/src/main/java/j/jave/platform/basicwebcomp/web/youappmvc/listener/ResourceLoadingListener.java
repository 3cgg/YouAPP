 ...
 * @author J
 */
public class ResourceLoadingListener implements ServletContextListener {
	private static final Logger LOGGER=LoggerFactory.getLogger(ResourceLoadingListener.class);
