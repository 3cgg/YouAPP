...
import j.jave.platform.basicwebcomp.web.youappmvc.multi.platform.filter.JLinkedRequestFilter;
...
public class JLinkedRequestSupport {
	...
	private class LinkedObjectTrace implements Trace<LinkedObject>{
		...
		private String pathInfo=JHttpUtils.getPathInfo(request);
		@Override
		public boolean store()throws Exception  {
			boolean stored=true;
	...
	public String get(){
		...
		if(LOGGER.isDebugEnabled()){
			...
			LOGGER.debug(linkedUniqueValue+"-the whole parameter->"+JHttpUtils.decode(object)); 
		}
		return object;
	}
	...
	public static String getParameter(HttpServletRequest request,String key) {
		Map<?,?> map=(Map<?, ?>) JHttpUtils.getAdditionalAttributesInRequestScope(request, LINKED_REQUEST_PARAM_KEY);
	...
	public static Map<String,Object> getParameters(HttpServletRequest request) {
		return (Map<String,Object>) JHttpUtils.getAdditionalAttributesInRequestScope(request, LINKED_REQUEST_PARAM_KEY);
	}
	 ...
	 * @see JHttpUtils#setAdditionalAttributesInRequestScope(HttpServletRequest, String, Object)
	 */
	public void setLinkedParameters(){
		String allParameters=get();
		Map<String,String> params= JHttpUtils.parseQueryString(JHttpUtils.decode(allParameters));
		JHttpUtils.setAdditionalAttributesInRequestScope(request, LINKED_REQUEST_PARAM_KEY, params);
	}
