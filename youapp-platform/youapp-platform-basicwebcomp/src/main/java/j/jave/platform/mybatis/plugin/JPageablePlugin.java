...
//				} else {
//					JPageImpl page=null;
//					if (parameterObject instanceof JPageable) { // 参数就是Page实体
//						JPageable pagination =(JPageable) parameterObject;
...
//		}
	 ...
	 * @return
	 */
	private String generatePageSql(String sql, JPageImpl page) {
...
//		}
	...
	private int handleOffset(JPageImpl page) {
