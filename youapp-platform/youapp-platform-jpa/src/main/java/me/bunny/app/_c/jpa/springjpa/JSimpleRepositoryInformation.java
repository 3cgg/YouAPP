package me.bunny.app._c.jpa.springjpa;
...
public class JSimpleRepositoryInformation implements RepositoryInformation{
	 ...
	 */
	public JSimpleRepositoryInformation(RepositoryMetadata metadata, Class<?> repositoryBaseClass,
