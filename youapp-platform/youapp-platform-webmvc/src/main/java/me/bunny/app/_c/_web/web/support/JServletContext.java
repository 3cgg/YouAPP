...
import me.bunny.app._c._web.web.youappmvc.jspview.JSPServletViewHandler;
...
public class JServletContext {
	...
	/**
	 * default to find {@link JSPServletViewHandler} , if multiple URL mappings found, return first.
	 * @return
	 */
			...
			synchronized (jspUrlSync) {
				if(jspServletUrls==null){
					...
					for(int i=0;i<servlets.size();i++){
						...
						if(servlet._class==JSPServletViewHandler.class){
