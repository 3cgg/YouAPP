    ...
    return {
        ...
        execute: function() {
            LoginComponnet = (function () {
                function LoginComponnet(_globalService, _loginService, _router) {
                ...
                LoginComponnet = __decorate([
                    ...
                    __metadata('design:paramtypes', [global_service_1.GlobalService, login_service_1.LoginService, (typeof (_a = typeof router_1.Router !== 'undefined' && router_1.Router) === 'function' && _a) || Object])
                ], LoginComponnet);
